...
async function generarComprobante() {
  ...
  ticketFull.style.cssText = `
    ...
    width: 1080px;
    height: 2400px;
    background: url('baseAndroid.jpg') center top / contain no-repeat;
    font-family: 'Manrope', sans-serif;
    color: #200020;
  `;

  ticketFull.innerHTML = `
    <div style="position:absolute;top:1128px;left:86px;font-size:39px;font-weight:400;">${inpPara.value}</div>
    <div style="position:absolute;top:1279px;left:86px;font-size:39px;font-weight:400;">${inpCuanto.value}</div>
    <div style="position:absolute;top:1423px;left:86px;font-size:39px;font-weight:400;">${inpNumero.value}</div>
    <div style="position:absolute;top:1570px;left:86px;font-size:39px;font-weight:400;">${inpFecha.value}</div>
  `;
